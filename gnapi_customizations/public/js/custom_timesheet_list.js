// Custom Timesheet List View Enhancements
// This file enhances the Custom Timesheet list view with better functionality
            ...
            if ($listView.length > 0) {
                ...
                const customActions = `
                    <div class="custom-timesheet-actions" style="margin: 10px 0;">
                        ...
                        <button class="btn btn-info btn-sm" onclick="frappe.route_options = {}; frappe.set_route('List', 'Custom Timesheet')">
